#Python program for Maze Solver

""" Solving a maze is a classic backtracking algo problem. """

""" We are given a maze that indicates the starting and ending points, Your goal is to design an algorithm,to:

1.Determine if there is a path from the start the start point to the end point
2.Specify your path without using circle or loops.
"""

""" A maze is a two-dimensional structure divided into rows and columns representings cells of equals size.

for this colorama module is used... """
